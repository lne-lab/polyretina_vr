...
public class FoveInterfaceBaseEditor : Editor
{
	...
	SerializedProperty _lockOrientation;
...
#pragma warning restore 618
	...
	protected virtual void EnableProperties()
	{
		...
		_lockOrientation = serializedObject.FindProperty("lockOrientation");
		CheckForNull(_lockOrientation, "_lockOrientation");
	...
	public sealed override void OnInspectorGUI()
	{
		...
		EditorGUI.BeginChangeCheck();
		{
			...
			EditorGUILayout.PropertyField(_lockOrientation);
			EditorGUI.indentLevel--;
		}
